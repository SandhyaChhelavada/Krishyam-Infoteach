        ...
        >
          ...
          >
            ...
            <div className="p-8">
              ...
              <h3 id="project-title" className="text-3xl md:text-4xl font-bold mb-4 text-gray-800">
                {selectedProject.title}
              </h3>

              <p className="text-gray-600 text-lg leading-relaxed mb-6">{selectedProject.fullDescription}</p>
              ...
              <div className="flex gap-4">
                <button
                  ...
                  // add real href or action for live demo if available
                >
                ...
                <button
                  ...
                  // add real href or action for repo if available
                >
                  <Github size={20} />
                  View Code
                </button>
